...
class MainRenderer extends BaseChartRenderer<CandleEntity> {
  ...
  MainRenderer(Rect mainRect, double maxValue, double minValue, double topPadding, this.state, this.isLine, int fixedLength, this.chartStyle,
      this.verticalTextMapper, this.chartColors, this.scaleX, this.verticalTextAlignment, [this.maDayList = const [5, 10, 20]])
      : super(
            chartRect: mainRect,
            maxValue: maxValue,
            minValue: minValue,
...
//    }
  ...
  void drawVerticalText(canvas, textStyle, int gridRows) {
    ...
    for (var i = 0; i <= gridRows; ++i) {
      ...
      String s = verticalTextMapper?.call(value) ?? format(value);
